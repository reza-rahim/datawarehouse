...
start() {
    echo "Starting Apache Ranger Admin Service in foreground mode"

    exec java -Dproc_rangeradmin ${JAVA_OPTS} \
        -Dlogback.configurationFile=file:${RANGER_ADMIN_LOGBACK_CONF_FILE} \
        ...
        -cp "${XAPOLICYMGR_EWS_DIR}/webapp/WEB-INF/classes/conf:${XAPOLICYMGR_EWS_DIR}/lib/*:${XAPOLICYMGR_EWS_DIR}/webapp/WEB-INF/lib/*:${RANGER_JAAS_LIB_DIR}/*:${RANGER_JAAS_CONF_DIR}:${JAVA_HOME}/lib/*:${RANGER_HADOOP_CONF_DIR}/*:$CLASSPATH" \
