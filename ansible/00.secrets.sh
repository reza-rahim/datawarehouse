...
export KEYCLOAK_JUPYTER_CLIENT_ID=jupiterhub
...
export SUPERSET_ADMIN_USER=superset
export SUPERSET_ADMIN_PASSWORD=superset
...
export KEYCLOAK_AIRFLOW_ID=d4e5b20b-ebbc-48ae-9842-e8ee2837d11b
export KEYCLOAK_AIRFLOW_CLIENT_ID=airflow
export KEYCLOAK_AIRFLOW_CLIENT_SECRET=e236ea34-6b6c-4024-9bb2-7c57aa627a0a


###
export KEYCLOAK_DEMO_USER=demo
export KEYCLOAK_DEMO_PASSWORD=demo
